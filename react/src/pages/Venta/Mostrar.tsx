        ...
        <Template title="Mostrar venta">
            ...
            {Venta.estado === "PAGADO" && Venta.token && (
                <div className="p-4 border rounded shadow bg-white my-5">
                    <h3 className="font-bold text-lg pb-1 mb-2 border-b-2 border-primary-700">¿Cómo recojo mi pedido?</h3>
                    <ol className="list-decimal ml-8 my-2 marker:font-bold">
                        <li>Acude a la sucursal de <span className="font-bold text-primary-700">La Flamita</span>.</li>
                        <li>Presenta el siguiente código en la caja.</li>
                    </ol>
                    <p className="italic my-2"><b>Importante:</b> No compartas el código con nadie, solo muestralo al llegar a la caja.</p>
                    
                    <div className="bg-primary-600 text-white p-5 my-4 rounded-lg flex flex-col items-center justify-center gap-2">
                    <QRCode value={Venta.token} size={240} bgColor="#f15d27" fgColor="white" />
                    <p className="mt-4 text-sm text-center font-bold tracking-wider">{ Venta.token }</p>
                    </div>
                </div>
            )}
