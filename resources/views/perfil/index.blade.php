...
<form class="my-8" action="/perfil/desactivar" method="POST">
  @csrf
  @method("DELETE")
  ...
  <div class="flex gap-4">
    <button onclick="return confirm('¿Desas desactivar tu cuenta?')" type="submit" class="grow mt-6 flex justify-center items-center gap-2 w-full text-secondary-700 bg-transparent hover:bg-secondary-600 hover:text-white focus:ring-4 focus:outline-none focus:ring-secondary-400 font-bold rounded-lg text-sm px-5 py-2.5 text-center active:bg-secondary-700 border border-2 border-secondary-700">
